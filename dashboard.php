...
<div class="container" style=" padding:40px; border:1px solid #ED2553;  width:100%;">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;" role="tablist">
          ...
          <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#manageaccount" role="tab" aria-controls="profile" aria-selected="false">TAMBAH MENU</a>
          </li>
		  <li class="nav-item">
              <a class="nav-link" id="status-tab" data-toggle="tab" href="#status" role="tab" aria-controls="status" aria-selected="false">PESANAN</a>
          </li>
                ...
                <form action="" method="post" enctype="multipart/form-data">
            		<div class="form-group">
                         <label for="food_name">MENU:</label>
                            <input type="text" class="form-control" id="food_name" value="<?php if(isset($food_name)) { echo $food_name;}?>" placeholder="Masukan Menu" name="food_name" required>
                    </div>
							 
							 
                    <div class="form-group">
                        <label for="cost">HARGA:</label>
                            <input type="number" class="form-control" id="cost"  value="<?php if(isset($cost)) { echo $cost;}?>" placeholder="Harga Menu" name="cost" required>
                    </div>
							 				 
	                <div class="form-group">
                        <label for="cuisines">MASAKAN:</label>
                            <input type="text" class="form-control" id="cuisines" value="<?php if(isset($cuisines)) { echo $cuisines;}?>" placeholder="Masukan Asal Makanan" name="cuisines" required>
                    </div>
							        
					<div class="form-group">
                        <label for="Food Type">Tipe Makanan:  </label><br>
                            <input type="radio" name="chk[]" value="Veg"/> Sayur<br>
			                <input type="radio" name="chk[]" value="Non-Veg"/> Tidak Sayur
						    <br>
	                ...
	                <div class="form-group">
                        Upload Gambar <br>
                            ...
                            <button type="submit" name="add" class="btn btn-primary">Tambah Masakan</button>
							<br>
