...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand" href="index.php">Kantin - UPB</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample07" aria-controls="navbarsExample07" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
                ...
                <?php
		            ...
		            <?php
		  	        ...
		  	        ?>
    						  ...
    						  &nbsp;
                  <a href="form/index.php"><button class="btn btn-info my-2 my-sm-0" name="login" type="submit">Masuk</button></a>
                  <a href="form/userSignUp.php"><button class="btn btn-primary my-2 my-sm-0" type="submit">Daftar</button></a>  
		  	        <?php
		  	    		    }
		  			      else
		  				      {
            ...
            <form class="form-inline my-2 my-md-0">
              <a href="sellerSignUp.php"><button type="button" class="btn btn-lg btn-block btn-warning">Admin Kantin <i class="fas fa-arrow-circle-right"></i></button></a>
            </form>
        </div>
  </div>
</nav>
  ...
  <main role="main">
    <div class="jumbotron" style="background: url(assets/images/bg-image1.jpg) no-repeat center / cover;">
      <div class="col-sm-8 mx-auto">
        <h1>Kantin Pelita Bangsa</h1>
        <p>Menyediakan Berbagai makanan dan minuman</p>
...
<div class="album py-5 bg-light">
  <div class="container">
    <h3 class="pb-3 mb-4  border-bottom">Paling Populer</h3>
    <div class="row">
      <?php
        if($pref==1)
        {
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
          <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
              ...
              Asal: <?php echo $res['cuisines']; ?> <br>
              <b>Rp</b>. <b><?php echo $res['cost']; ?></b></p>
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <form method="post">
                  <button type="submit" class="btn btn-sm btn-success" name="addtocart" value="<?php echo $res['food_id'];?>">Pesan</button>
                </form>
              </div>
